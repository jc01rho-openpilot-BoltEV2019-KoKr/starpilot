...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"AutoNaviSpeedCtrlStart", {PERSISTENT, INT, "22", "22", 0}},
    {"AutoNaviSpeedCtrlEnd", {PERSISTENT, INT, "11", "11", 0}},
    ...
    {"LowVoltageDiscordPendingReport", {PERSISTENT | DONT_LOG, JSON, "[]", "[]"}},
    {"LowVoltageDiscordReport", {PERSISTENT, BOOL, "0", "0", 0, SETTINGS_SIMPLE}},
