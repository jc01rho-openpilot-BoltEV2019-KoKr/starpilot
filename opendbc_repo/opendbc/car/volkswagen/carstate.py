...
class CarState(CarStateBase):
  ...
  def update_pq(self, pt_cp, cam_cp, alt_cp, ext_cp) -> tuple[structs.CarState, custom.StarPilotCarState]:
    ret = structs.CarState()
    fp_ret = custom.StarPilotCarState.new_message()
  ...
  def update_meb(self, pt_cp, cam_cp, alt_cp, ext_cp) -> tuple[structs.CarState, custom.StarPilotCarState]:
    ret = structs.CarState()
    fp_ret = custom.StarPilotCarState.new_message()
    ...
    self.radar_disable_failed = RADAR_DISABLE_STATE["error"] and bool(self.CP.flags & VolkswagenFlags.DISABLE_RADAR)
    ...
    fp_ret.dashboardSpeedLimit = self.speed_limit
  ...
  def update_mlb(self, pt_cp, cam_cp, ext_cp, alt_cp) -> tuple[structs.CarState, custom.StarPilotCarState]:
    ret = structs.CarState()
    fp_ret = custom.StarPilotCarState.new_message()
