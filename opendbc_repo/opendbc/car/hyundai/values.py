...
class CarControllerParams:
  ...
  ANGLE_RAMP_UP_TORQUE_REDUCTION_RATE = 0.008
  ANGLE_RAMP_DOWN_TORQUE_REDUCTION_RATE = 0.0012
  ANGLE_TORQUE_OVERRIDE_CYCLES = 17
  SMOOTHING_ANGLE_VEGO_MATRIX = [0.0, 8.5, 11.0, 13.8, 22.22]
