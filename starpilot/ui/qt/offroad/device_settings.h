...
private:
  ...
  QSet<QString> deviceManagementKeys = {"DeviceShutdown", "DisableWideRoad", "HigherBitrate", "IncreaseThermalLimits", "LowVoltageDiscordReport", "LowVoltageShutdown", "NoLogging", "NoUploads", "UseKonikServer"};
